...
public class Draft extends Activity {
	...
	public void DialogSave()
	{
		...
		final Dialog info=new Dialog(Draft.this);
		info.getWindow();
		...
		lv.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
				...
				// TODO Auto-generated method stub
				AlertDialog.Builder alt = new AlertDialog.Builder(Draft.this);
				alt.setTitle(
						...
						.setItems(Dialoginboxoption, new OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								switch (which) {
								case 0:
									Intent i = new Intent(Draft.this,
											Create_msg.class);
						...
						.setItems(inboxoption, new OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								/*	deleteSMS(Draft.this, lmessage
									...
									try
									{
									deleteSMS(Draft.this,dataHash.get(
	...
	public void ChangeListen() {
		...
		ltime.clear();
		lsender.clear();
		Draft.this.getSMS(inbox.getText().toString());
	...
	public void ChangeListenDialog() {
		...
		Dltime.clear();
		Dlsender.clear();
		Draft.this.getSMSDialog(inbox.getText().toString());
	...
	public void getSMS(String add) {
		...
		Uri uriSMSURI = Uri.parse("content://sms/draft");
		...
		while (cur.moveToNext()) {
			...
			lsender.add(address);
			lname.add(Draft.this.getDisplayName(address));
	...
	public void getSMSDialog(String add) {
		...
		while (cur.moveToNext()) {
			...
			Dlname.add(Draft.this.getDisplayName(address));
	...
	public void CreatObjects() {
		...
		m_ClipboardManager = (ClipboardManager) Draft.this
	...
	public class InboxRetrive extends AsyncTask<String, Integer, Integer> {
		...
		protected void onPostExecute(Integer result) {
			...
			Draft.this.finish = true;
			Draft.this.typeOrNot = false;
			pro.cancel();
			if(pressedSearch)
				//Toast.makeText(Draft.this,inbox.getText().toString(), 1).show();
			Draft.this.lv.setAdapter(nAdapter);
			else
				DialogSave();
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			pro = new ProgressDialog(Draft.this);
			pro.setTitle("Draft");
		...
		protected Integer doInBackground(String... params) {
			...
			{
				if (sharedStart) {
					Draft.this.SharedTrigger();
					sharedStart = false;
					publishProgress();
					}
				if(pressedSearch)
				Draft.this.ChangeListen();
				else
				Draft.this.ChangeListenDialog();
